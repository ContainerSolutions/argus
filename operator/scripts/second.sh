...
state=$(az policy state list --resource "/subscriptions/2f2d0095-02f7-42ee-bd27-9559b16fcd21/resourcegroups/argus/providers/microsoft.containerregistry/registries/argussecond" --query "[?policyDefinitionId=='/providers/microsoft.authorization/policydefinitions/d0793b48-0edc-4296-a390-4c75d1bdfd71']" | jq -r '.[].complianceState')
