...
func TestGetAttestationClient(t *testing.T) {
	...
	testCases := []struct {
		...
		prov          MockProvider
		NewFn         func(*argusiov1alpha1.AttestationProviderSpec) (schema.AttestationClient, error)
		spec          *argusiov1alpha1.ResourceAttestation
		cl            client.Client
...
type MutationFn func(*argusiov1alpha1.ResourceAttestation)

func makeResourceAttestation(f ...MutationFn) *argusiov1alpha1.ResourceAttestation {
